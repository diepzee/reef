...
from reef.opendoor import door_policy
...
# reef.web.routes_auth's _registered set; both assume mcp is a process-wide
...
#: :mod:`reef.opendoor` is built to close itself on a date nobody has to be
