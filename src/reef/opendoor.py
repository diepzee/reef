...
reef is invitation-only (:mod:`reef.auth`), and that is the steady state. This
...
from reef.identity import IdentityRow, _one
...
async def admit(email: str, subject: str, display_name: str) -> IdentityRow | None:
    ...
    The mirror image of :func:`reef.invitations.allowlist`, which refuses to
