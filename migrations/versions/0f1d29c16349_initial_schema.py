...
def upgrade() -> None:
    ...
    # RLS policy DDL lives in rif.rls, shared with tests/conftest.py's
    # `engine` fixture, so production and tests can never apply different
    # policies. See that module's docstring for the NULLIF rationale.
