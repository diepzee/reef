 ...
 * user-cove coords are safe for any geometry drawn in this box.
 */

import { useId } from "react";

/** Potrace path of the brain coral, in the traced source's pixel cove. */
const BRAIN_D =
 ...
 * its base on y=52; inner is Potrace's source-cove flip. Copied from reef.svg
 * — keep in sync.
 */
...
interface FrondGlyphProps {
  /** Fill color — a cove hue, `var(--accent)`, or `currentColor`. */
  color: string;
...
/**
 * The mark alone — a single-color glyph for cove chips and brand lockups.
 * The padded crop keeps the negative-cove branches open at small sizes and
